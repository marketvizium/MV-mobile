...
export default defineComponent({
  ...
  methods: {
    async fetchQuotes() {
      ...
      this.error = false;
      try {
        // CotacaoEspecifica recebe o id da loja via query da rota e consulta
        // especificamente as cotações dessa loja (endpoint diferencia
        // internamente quando id_loja != 0).
